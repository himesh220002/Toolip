...
export const INITIAL_TOOLS: ToolItem[] = [
  ...
  {
    id: 'table-to-csv',
    title: 'Table ↔ CSV ↔ JSON Editor',
    category: 'Document & File Utilities',
    description: 'Bi-directional Table, CSV, TSV, Markdown, HTML Table, and JSON array converter & live interactive editor.',
    iconName: 'Table',
    status: 'completed',
    notes: 'Bi-directional Table ↔ CSV ↔ JSON ↔ HTML editor with live syntax error alerts and spreadsheet grid controls.',
    features: ['Bi-directional Table ↔ CSV ↔ JSON ↔ HTML', 'Live JSON Syntax Error Alerts', 'Spreadsheet Grid Editor & Targeted Row/Col Placement', 'Auto-Delimiter & Excel Copy/Paste Support'],
    updatedAt: '2026-09-06T00:00:00.000Z',
    seoKeywords: ['table csv json editor', 'table to csv', 'csv to json converter', 'html table editor', 'json to csv'],
  },
  {
    id: 'svg-code-editor',
  ...
  },
  {
    ...
    iconName: 'Network',
    status: 'completed',
    notes: 'Interactive graph builder with canvas panning, node dragging, root & child node toolbars, and yFiles GraphML export/import.',
    features: ['Root & Secondary Node Toolbars', 'Emoji Icons & Arrow Styling', 'Empty Canvas Click Node Creator', 'Save & Open mindmap.graphml'],

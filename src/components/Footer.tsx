        ...
        <div className="max-w-[1420px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-7 sm:pb-8">
            ...
            <Link href="/" className="flex items-center gap-3 shrink-0 hover:opacity-90 transition-opacity">
              <div className="relative h-16 w-16 rounded-xl  flex items-center justify-center shrink-0">
                <Image
              ...
              <div className="leading-none">
                ...
                <div className="font-mono text-[8px] tracking-[0.18em] font-bold text-white/40">EVERYDAY UTILITIES • 34 TOOLS</div>
              </div>

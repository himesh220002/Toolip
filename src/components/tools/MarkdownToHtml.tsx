      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 bg-slate-900/90 border border-slate-800 rounded-3xl space-y-3 backdrop-blur-xl">
          ...
          <textarea
            ...
            className="w-full h-96 p-4 bg-slate-950 border border-slate-800 rounded-2xl font-mono text-xs text-sky-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none shadow-inner leading-relaxed"
          />
        </div>
        ...
        <div className="p-5 bg-slate-900/90 border border-slate-800 rounded-3xl space-y-3 backdrop-blur-xl">
          ...
          {viewMode === 'rendered' ? (
            <div
              className="w-full h-96 p-5 bg-white rounded-2xl text-slate-900 text-sm overflow-auto shadow-2xl prose max-w-none border border-slate-700"
            ...
            <textarea
              readOnly
              value={htmlOutput}
              className="w-full h-96 p-4 bg-slate-950 border border-slate-800 rounded-2xl font-mono text-xs text-emerald-300 focus:outline-none resize-none shadow-inner"
            />
          )}
        </div>
      </div>
